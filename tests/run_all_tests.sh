...
echo "[1/11] Running test_tong_hop_link.mjs..."
node tests/test_tong_hop_link.mjs

echo "[2/11] Running test_telegram_phanserver.mjs..."
node tests/test_telegram_phanserver.mjs

echo "[3/11] Running test_fleet_state_2pc.mjs..."
node tests/test_fleet_state_2pc.mjs

echo "[4/11] Running test_pairing.mjs..."
node tests/test_pairing.mjs

echo "[5/11] Running test_worker_security.mjs..."
node tests/test_worker_security.mjs

echo "[6/11] Running test_credential_rotation.mjs..."
node tests/test_credential_rotation.mjs

echo "[7/11] Running test_hibernation_transport.mjs..."
node tests/test_hibernation_transport.mjs

echo "[8/11] Running delta updater tests..."
python3 -m unittest discover -s delta/tests

echo "[9/11] Running device agent tests..."
python3 -m unittest discover -s agent/tests

echo "[10/11] Running onboarding installer tests..."
python3 tests/test_onboarding_install.py

echo "[11/11] Running E2E flow tests..."
