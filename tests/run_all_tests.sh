...
echo "[1/6] Running test_tong_hop_link.mjs..."
node tests/test_tong_hop_link.mjs

echo "[2/6] Running test_telegram_phanserver.mjs..."
node tests/test_telegram_phanserver.mjs

echo "[3/6] Running test_fleet_state_2pc.mjs..."
node tests/test_fleet_state_2pc.mjs

echo "[4/6] Running delta updater tests..."
python3 -m unittest discover -s delta/tests

echo "[5/6] Running device agent tests..."
python3 -m unittest discover -s agent/tests

echo "[6/6] Running E2E flow tests..."
